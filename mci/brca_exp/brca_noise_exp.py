...
if __name__ == '__main__':
    ...
    n_noise_feautres = sys.argv[1]
    n_processes = sys.argv[2] if len(sys.argv) > 2 else 10
    ...
    estimator = PermutationSampling(evaluator=evaluator, out_dir=exp_name,  n_processes=1,
